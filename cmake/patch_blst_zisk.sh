#!/bin/sh
# Patch blst's vect.h, fields.h and no_asm.h for ZISK BLS12-381 syscalls.
#
...
#   4-byte alignment. ZISK syscalls require 8-byte alignment, so the old
...
#
# The ZISK syscalls perform PLAIN modular arithmetic (not Montgomery).
...
grep -q "ZISK_BLS12381_SYSCALLS" "$FIELDS_H" && { echo "Already patched"; exit 0; }
...
/* rv64im: use 64-bit limbs for native 8-byte alignment (ZISK syscall compat) */
...
decls = r"""
/* ── ZISK BLS12-381 syscall acceleration ── */
#ifdef ZISK_BLS12381_SYSCALLS
/* BLS12-381 base field prime P (little-endian u64 limbs):
   p = 0x1a0111ea397fe69a4b1ba7b6434bacd764774b84f38512bf6730d2a0f6b0f6241eabfffeb153ffffb9feffffffffaaab */
static const unsigned long long _ZISK_BLS12_381_P[6] = {
    0xb9feffffffffaaabULL, 0x1eabfffeb153ffffULL, 0x6730d2a0f6b0f624ULL,
    0x64774b84f38512bfULL, 0x4b1ba7b6434bacd7ULL, 0x1a0111ea397fe69aULL
};
/* P-1 — used to express subtraction as (P-1)·b + a ≡ -b + a (mod P). */
static const unsigned long long _ZISK_BLS12_381_P_MINUS_1[6] = {
    0xb9feffffffffaaaaULL, 0x1eabfffeb153ffffULL, 0x6730d2a0f6b0f624ULL,
    0x64774b84f38512bfULL, 0x4b1ba7b6434bacd7ULL, 0x1a0111ea397fe69aULL
};
static const unsigned long long _ZISK_ONE_384[6]  = {1, 0, 0, 0, 0, 0};
static const unsigned long long _ZISK_ZERO_384[6] = {0, 0, 0, 0, 0, 0};

/* Rust SyscallArith384ModParams mirror: {a,b,c,module,d} — d ← (a·b + c) mod module. */
struct _zisk_arith384mod_params {
    const unsigned long long* a;
    const unsigned long long* b;
    const unsigned long long* c;
    const unsigned long long* module;
    unsigned long long*       d;
};
/* Rust SyscallBls12_381Complex*Params mirror: {f1: &mut, f2: &const}. f1 updated in-place. */
struct _zisk_complex_params {
    void*       f1;
    const void* f2;
};

/* Fp addmod via ARITH384_MOD (CSR 0x80B): p = (1·p + q) mod P */
static inline __attribute__((always_inline)) void
syscall_bls12381_fp_addmod(unsigned long long* p, const unsigned long long* q) {
    struct _zisk_arith384mod_params params = { _ZISK_ONE_384, p, q, _ZISK_BLS12_381_P, p };
    __asm__ volatile("csrs 0x80b, %0" : : "r"(&params) : "memory");
}
/* Fp submod: p = ((P-1)·q + p) mod P = (p - q) mod P */
static inline __attribute__((always_inline)) void
syscall_bls12381_fp_submod(unsigned long long* p, const unsigned long long* q) {
    struct _zisk_arith384mod_params params = { _ZISK_BLS12_381_P_MINUS_1, q, p, _ZISK_BLS12_381_P, p };
    __asm__ volatile("csrs 0x80b, %0" : : "r"(&params) : "memory");
}
/* Fp mulmod: p = (p·q + 0) mod P */
static inline __attribute__((always_inline)) void
syscall_bls12381_fp_mulmod(unsigned long long* p, const unsigned long long* q) {
    struct _zisk_arith384mod_params params = { p, q, _ZISK_ZERO_384, _ZISK_BLS12_381_P, p };
    __asm__ volatile("csrs 0x80b, %0" : : "r"(&params) : "memory");
}
/* Fp2 add (0x80E) / sub (0x80F) / mul (0x810) — same two-pointer ABI as Rust SyscallComplex384. */
static inline __attribute__((always_inline)) void
syscall_bls12381_fp2_addmod(unsigned long long* p, const unsigned long long* q) {
    struct _zisk_complex_params params = { p, q };
    __asm__ volatile("csrs 0x80e, %0" : : "r"(&params) : "memory");
}
static inline __attribute__((always_inline)) void
syscall_bls12381_fp2_submod(unsigned long long* p, const unsigned long long* q) {
    struct _zisk_complex_params params = { p, q };
    __asm__ volatile("csrs 0x80f, %0" : : "r"(&params) : "memory");
}
static inline __attribute__((always_inline)) void
syscall_bls12381_fp2_mulmod(unsigned long long* p, const unsigned long long* q) {
    struct _zisk_complex_params params = { p, q };
    __asm__ volatile("csrs 0x810, %0" : : "r"(&params) : "memory");
}

/* R_INV = (2^384)^{-1} mod P (Montgomery undo factor — same as SP1). */
static const unsigned long long _ZISK_FP_R_INV[6] = {
...
static const unsigned long long _ZISK_FP2_R_INV[12] = {
    0xf4d38259380b4820ULL, 0x7fe11274d898fafbULL, 0x343ea97914956dc8ULL,
    0x1797ab1458a88de9ULL, 0xed5e64273c4f538bULL, 0x14fec701e8fb0ce9ULL,
...
# ZISK syscalls read both operands atomically before writing result.
...
new_sqr_fp2 = """static inline void sqr_fp2(vec384x ret, const vec384x a)
{
    ...
    syscall_bls12381_fp2_mulmod((unsigned long long *)ret, _ZISK_FP2_R_INV);
#else
    sqr_mont_382x(ret, a, BLS12_381_P, p0);
#endif
}"""
...
# ── Replace MUL_MONT_IMPL(384) with ZISK-accelerated versions ──
...
sp1_mul_sqr_384 = r"""/* ZISK-patched: mul_mont_384 and sqr_mont_384 via syscalls (aliasing-aware) */
#ifdef ZISK_BLS12381_SYSCALLS
static const unsigned long long _zisk_no_asm_R_INV[6] = {
    0xf4d38259380b4820ULL, 0x7fe11274d898fafbULL, 0x343ea97914956dc8ULL,
    0x1797ab1458a88de9ULL, 0xed5e64273c4f538bULL, 0x14fec701e8fb0ce9ULL
};
                          ...
                          const vec384 p, limb_t n0)
{
    ...
    if (ret == a) {
        ...
        syscall_bls12381_fp_mulmod((unsigned long long *)ret, _zisk_no_asm_R_INV);
    } else if (ret == b) {
        ...
        syscall_bls12381_fp_mulmod((unsigned long long *)tmp, _zisk_no_asm_R_INV);
        vec_copy(ret, tmp, sizeof(vec384));
    } else {
...
new_add_384 = r"""/* ZISK-patched: add_mod_384 via syscall (BLS12-381 only) */
#ifdef ZISK_BLS12381_SYSCALLS
...
new_sub_384 = r"""/* ZISK-patched: sub_mod_384 via syscall (BLS12-381 only) */
#ifdef ZISK_BLS12381_SYSCALLS
...
# ── Replace REDC_MONT_IMPL(384, 768) with ZISK-accelerated version ──
...
sp1_redc_384 = r"""/* ZISK-patched: redc_mont_384 via syscalls (no aliasing possible) */
#ifdef ZISK_BLS12381_SYSCALLS
__attribute__((always_inline))
...
# ── Replace FROM_MONT_IMPL(384) with ZISK-accelerated version ──
# from_mont_384(ret, a, p, n0) = a * R^{-1} mod P

sp1_from_384 = r"""/* ZISK-patched: from_mont_384 via syscalls (aliasing-aware) */
#ifdef ZISK_BLS12381_SYSCALLS
__attribute__((always_inline))
...
# ZISK version: use our patched sqr_mont_384 + mul_mont_384.
...
# ── Patch cneg_mod_384 with ZISK syscall ──
# cneg_mod_384(ret, a, flag, p) = flag ? (p - a) : a
# With ZISK syscalls: compute p - a via sub_mod syscall, then conditionally select.
...
new_cneg_384 = r"""/* ZISK-patched: cneg_mod_384 via sub_mod syscall */
#ifdef ZISK_BLS12381_SYSCALLS
...
if old_cneg_384 in src:
    ...
    print("Patched cneg_mod_384 with ZISK syscall")
else:
...
new_lshift_384 = r"""/* ZISK-patched: lshift_mod_384 via repeated add_mod_384 syscall */
#ifdef ZISK_BLS12381_SYSCALLS
...
if old_lshift_384 in src:
    ...
    print("Patched lshift_mod_384 with ZISK add syscall")
else:
...
new_mul_by_3_384 = r"""/* ZISK-patched: mul_by_3_mod_384 via add_mod_384 syscall */
#ifdef ZISK_BLS12381_SYSCALLS
...
if old_mul_by_3_384 in src:
    ...
    print("Patched mul_by_3_mod_384 with ZISK add syscall")
else:
